---
title: 【学习笔记】通过文字检索视频片段：VCED——Streamlit前端简介
date: 2022-11-21 01:12:30
...
![](【学习笔记】通过文字检索视频片段：VCED——Streamlit前端简介/streamlit_demo.png)

## 使用 Streamlit 复现 VCED 项目的前端页面

VCED项目实现的流程有：上传视频、输入描述、限定搜索个数、搜索按钮等功能。
